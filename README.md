...
The purpose of the script is to create an environment with all the necessary tools for red teaming and creates directories under the following directories: 
